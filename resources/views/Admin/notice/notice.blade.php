...
<div class="x-body">
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加公告','/admin/notice/add',600,400)"><i class="layui-icon"></i>添加</button>
    ...
    <table class="layui-table" id="datatable">
        ...
        @foreach($db as $key=>$value)
            <tr>
                ...
                <td>{{$value->form}}</td>
                <td class="td-manage">
                    <a onclick="x_admin_show('修改公告信息','/admin/notice/edit/{{$value->id}}',600,600)" title="修改书籍信息" href="javascript:;">
